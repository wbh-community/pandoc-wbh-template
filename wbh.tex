    ...
    $if(assignment.file)$
        ...
        $if(assignment.fillform)$
            ...
            \begin{tikzpicture}[remember picture, overlay, x=1mm,y=1mm,%
                ...
                \node at (34,-34) [info] {$student.firstname$}; % etwas länger länger};
                \node at (95,-34) [info] {$student.lastname$}; % etwas länger länger};
                \node at (34,-47) [info] {$student.strasse$};
                \node at (95,-47) [info] {$student.ort$}; % etwas länger länger};
                \node at (34,-59) [info] {$student.matrikelnr$}; % etwas länger länger};
                \node at (95,-59) [info] {$studium.studiengangnr$}; % etwas länger länger};
